...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOD, LAN9253_CS_Pin|LAN9253_RST_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LED2_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pins : LAN9253_SYNC1_Pin LAN9253_SYNC0_Pin */
  GPIO_InitStruct.Pin = LAN9253_SYNC1_Pin|LAN9253_SYNC0_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_FALLING;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  HAL_GPIO_Init(GPIOE, &GPIO_InitStruct);

  /*Configure GPIO pin : LAN9253_CS_Pin */
  GPIO_InitStruct.Pin = LAN9253_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_PULLUP;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(LAN9253_CS_GPIO_Port, &GPIO_InitStruct);
